...
class _TripDetailScreenState extends ConsumerState<TripDetailScreen> {
  ...
  Future<void> _onStartTrip() async {
    if (mounted) {
      context.push('/conductor/boarding/${widget.tripId}');
    }
  }
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                StatusChip(
                                    status: trip.isActive ? 'active' : 'ready'),
                              ],
                            ),
                            const Spacer(),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Conductor row (you)
                              _CrewTile(
                                  role: 'CONDUCTOR', name: 'You', isYou: true),
                            ],
                          ),
                        ),
                      ],
            ...
            children: [
              Container(
                  ...
                  decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color:
                          active ? const Color(0xFF4CAF50) : AppColors.error)),
...
class _CrewTile extends StatelessWidget {
  ...
  final bool isYou;
  const _CrewTile(
      {required this.role, required this.name, required this.isYou});
  @override
  Widget build(BuildContext context) {
    return Container(
