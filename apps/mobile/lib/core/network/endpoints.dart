...
class Endpoints {
  ...
  static String login =
      '/api/auth/login'; // Keeping for backward comp if needed
  static String me = '/api/auth/me';
  ...
  // ── Passengers ────────────────────────────────────────────────────────────
  static String tripPassengers(String tripId) =>
      '/api/trips/$tripId/passengers';
  static String confirmPassengers(String tripId) =>
      '/api/trips/$tripId/passengers/confirm';
  static String geoLibrary = '/api/geo-library';
  static String reverseGeocode(double lat, double lng) =>
      '/api/routes/reverse-geocode?lat=$lat&lng=$lng';
}
