...
(0, node_test_1.default)('End-to-End Gujarat Pilot Complete Trip Flow', async (t) => {
    let agencyId;
    let operatorToken;
    let conductorToken;
    let driverToken;
    ...
    await t.test('Step 1: Setup - Verify server is running', async () => {
        ...
        node_assert_1.default.strictEqual(res.status, 200, 'Backend API is not reachable');
    });
